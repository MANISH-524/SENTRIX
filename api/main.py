...
app = FastAPI(title="SENTRIX API", description="Autonomous Recovery & Resilience Intelligence — Control API", version=config.VERSION)
...
def _startup():
    ...
    # restore recent history from SQLite so restarts don't blank the dashboard
    try:
